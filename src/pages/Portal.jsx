        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 leading-relaxed">
              The DojiFx Client Portal is your secure hub for managing your trading accounts, funds, documents, and partnerships. It's designed for simplicity without sacrificing power.
            </p>
            {[
      ...
      <section className="bg-gradient-to-r from-gold-600 to-gold-800 text-white py-16">
        <div className="max-w-3xl mx-auto text-center px-4">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="https://portal.DojiFx.com/login" className="flex items-center gap-2 bg-white text-gold-600 font-semibold px-8 py-3 rounded-xl hover:bg-gray-100 transition-colors">
              Sign In <ArrowRight className="w-4 h-4" />
            </a>
            <a href="https://portal.dojifx.com/signup" className="flex items-center gap-2 border border-white text-white font-semibold px-8 py-3 rounded-xl hover:bg-gold-700 transition-colors">
