...
const FAQS = [
  ...
  { q: 'What documents do I need for verification?', a: 'A government-issued ID (passport or national ID) and a proof of address document (utility bill or bank statement) dated within 6 months.' },
  { q: 'What is the minimum deposit?', a: 'Minimum deposits vary by account: Classic $10, Islamic $50, Standard $30, Premium $200, ECN $500, and Signature $5,000.' },
  ...
  { q: 'What are the commission charges?', a: 'Standard and Premium accounts: $3.5 per lot. ECN account: $7 per lot. Signature: $3.5 per lot. Classic and Islamic have no commission.' },
  { q: 'How does the 30% bonus work?', a: 'Get 30% bonus on deposits. Requires 3 lots trading to activate. Must complete 10 lots trading volume before withdrawal. Bonus is not withdrawable but can be used for trading.' },
